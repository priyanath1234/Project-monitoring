...
<div class="col-lg-8">
    ...
    <thead>
      <tr id="heads">
        ...
        <th class="col-md-2 text-center">Experinece</th>
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><?php echo $row['daily_rate'].' Years' ?></td>
...
<div id="add_form">
	...
	<form method="POST" id="pos_form">
		...
		<div class="form-horizontal">
			<div class="form-group">
			<div class="col-sm-4"><label class="control-label" for="dr">Experinece</label></div>
				<div class="col-sm-5">
					<input type="number" style="text-align:right" class="form-control input-sm" name="dr" id="dr" placeholder="years" required/>
				</div>
			</div>
		</div>	
		<hr style="border-bottom:1px solid grey"></hr>
